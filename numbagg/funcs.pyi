...
def nanvar(arrays, /, *, ddof: int = 1, axis: AxisLike | None = None): ...
def nanstd(arrays, /, *, ddof: int = 1, axis: AxisLike | None = None): ...
def nanargmax(arr: NDArray[Any], *args, axis: AxisLike | None = None): ...
def nanargmin(arr: NDArray[Any], *args, axis: AxisLike | None = None): ...
def nanmax(arr: NDArray[Any], *args, axis: AxisLike | None = None): ...
def nanmin(arr: NDArray[Any], *args, axis: AxisLike | None = None): ...
...
def nanmedian(
    a: NDArray[np.float64], *, axis: AxisLike | None = None, **kwargs
) -> np.ndarray: ...
def bfill(
    arr: _T,
    *,
